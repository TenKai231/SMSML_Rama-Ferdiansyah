...
if __name__ == "__main__":
    ...
    # Ambil file path dari argument atau default ke dataset_preprocessing.csv
    file_path = sys.argv[3] if len(sys.argv) > 3 else os.path.join(current_dir, "dataset_preprocessing.csv")
